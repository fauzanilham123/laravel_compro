                    ...
                    <section class="py-14 lg:py-[100px]">
                        <div class="container">
                            <div class="heading text-center ltr:lg:text-left rtl:lg:text-right">
                                <h4 class="sm:!leading-[50px]">Hallo! Mepy</h4>
                            </div>
                            <div class="mb-10 grid gap-[30px] md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <div class="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    @foreach($settings as $setting)
                                    <h5 class="font-bold text-black dark:text-white lg:text-lg">{{ $setting->address}}</h5>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="w-full h-full">
                                <iframe
                                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.4823698075647!2d107.68754987591456!3d-6.952285768065906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c3e0dfeed99b%3A0x84c50ff3f8f9f399!2sSummarecon%20Bandung%202!5e0!3m2!1sid!2sid!4v1694586422560!5m2!1sid!2sid"
                                  style="border:0;"
                                  allowfullscreen=""
                                  loading="lazy"
